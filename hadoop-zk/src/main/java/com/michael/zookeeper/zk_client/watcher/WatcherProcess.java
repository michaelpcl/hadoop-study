package com.michael.zookeeper.zk_client.watcher;

import com.michael.zookeeper.zk_client.ZkClient;
import com.michael.zookeeper.zk_client.ZkClientException;
import com.michael.zookeeper.zk_client.listener.*;
...
public class WatcherProcess {
    ...
    private final ConcurrentHashMap<Integer, StateListener> statePool = new ConcurrentHashMap<Integer, StateListener>();//客户端状态监听池
